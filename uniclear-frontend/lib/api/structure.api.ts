...
export const structureApi = {
  ...
  createDepartment: (facultyId: string, name: string, availableLevels?: string[]) => apiClient.post<{ success: true; data: any }>('/structure/departments', { facultyId, name, availableLevels }),
